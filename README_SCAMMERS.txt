...
This project is a static HTML site. `vercel.json` is included so Vercel serves it as a static site.
Do not use a framework build command. The Online Services page works immediately with an empty
`assets/services/index.json`; products are added later through the normal GitHub Action.
